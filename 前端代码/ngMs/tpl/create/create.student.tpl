			...
			<div class="panel-body">
				<form name="create" class="create-container" ng-submit="createStudent()">
					...
					<div class="row">
						...
						<div class="col-sm-4" ng-show="create.name.$dirty && create.name.$invalid"><span class="alert alert-warning">姓名不得少于2位</span></div>
					</div>
					...
					<div class="row">
						<div class="col-sm-2 col-sm-offset-2">
							<input  type="submit" value="添加学生" class="btn btn-success">
						</div>
